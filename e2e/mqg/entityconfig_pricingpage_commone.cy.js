import * as data from "../../fixtures/mqg_qa/config_commone.json"
...
const prdName1 = Cypress.env('prdName1')
...
before(() => {
    ...
    cy.wait(1000)
    ProductWizardPage.selectProduct(prdName1, relationshipName, testEnv)
...
describe('Verify Field configurations in Product Attributes Section', () => {
    ...
    let dropDownFields = ['productcurrencyCode', 'productcreditRatingCode', 'producttreatmentType', 'productloanPurpose', 'productsecurityType',
     'productmixedSecurityOption', 'productlvr', 'productlGDOverride',]
...
describe('Verify Field configurations in Rates Section', () => {
    // Fields that will be tested
    let inputTextFields = ['productterm', 'productderivedCOF', 'productmarginOverReferenceRate', 'productderivedInterest', 'productmarginRate']
...
describe('Verify that the Pricing Page Wizard Page should have the Fees and Cost table configuratrion', () => {
    ...
    it('Verify Fees Table Configuration configuration for Facility Fees', () => {
        ...
        ProductPage.validatePaymentFreq("Facility Fees", data, "enabled")

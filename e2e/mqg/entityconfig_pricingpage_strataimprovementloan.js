import * as data from "../../fixtures/mqg_qa/config_strataimprovementloan.json"
...
const prdName7 = Cypress.env('prdName7')
...
before(() => {
    ...
    cy.wait(1000)
    ProductWizardPage.selectProduct(prdName7, relationshipName, testEnv)

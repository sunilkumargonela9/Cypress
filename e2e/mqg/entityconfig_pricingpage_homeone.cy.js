import * as data from "../../fixtures/mqg_qa/config_homeone.json"
...
const prdName3 = Cypress.env('prdName3')
...
before(() => {
    ...
    cy.wait(1000)
    ProductWizardPage.selectProduct(prdName3, relationshipName, testEnv)
...
describe('Verify Field configurations in Product Attributes Section', () => {
    ...
    let dropDownFields = ['productcurrencyCode', 'productcreditRatingCode', 'producttreatmentType', 'productsecurityType', 'productloanPurpose',
    'productmixedSecurityOption', 'productlvr']
...
describe('Verify Field configurations in Rates Section', () => {
    // Fields that will be tested
    let inputTextFields = ['productterm', 'productderivedCOF', 'productmarginOverReferenceRate', 'productmarginRate', 'productpBRate']

    let dropDownFields = ['productrepaymentType', 'productinterestRateType', 'productinterestRateFrequency', 'productrefRate']
...
describe('Verify that the Pricing Page Wizard Page should have the Fees and Cost table configuratrion', () => {
    ...
    it('Verify Fees Table Configuration configuration for Renegotiation Fees', () => {
        ...
        ProductPage.validatePaymentFreq("Renegotiation Fees", data, "edisabled")
        ProductPage.validateTableDdlFieldOptions("Renegotiation Fees", data)

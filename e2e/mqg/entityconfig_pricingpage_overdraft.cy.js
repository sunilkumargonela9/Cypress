import * as data from "../../fixtures/mqg_qa/config_overdraft.json"
...
const prdName5 = Cypress.env('prdName5')
...
before(() => {
    ...
    cy.wait(1000)
    ProductWizardPage.selectProduct(prdName5, relationshipName, testEnv)
...
describe('Verify Field configurations in Rates Section', () => {
    // Fields that will be tested
    let inputTextFields = ['productderivedCOF', 'productmarginOverReferenceRate', 'productderivedInterest', 'productmarginRate', 'productpBRate']

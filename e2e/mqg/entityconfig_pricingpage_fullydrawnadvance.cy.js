import * as data from "../../fixtures/mqg_qa/config_fullydrawnadvance.json"
...
const prdName2 = Cypress.env('prdName2')
...
before(() => {
    ...
    cy.wait(1000)
    ProductWizardPage.selectProduct(prdName2, relationshipName, testEnv)

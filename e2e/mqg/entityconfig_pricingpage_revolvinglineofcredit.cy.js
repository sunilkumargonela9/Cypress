import * as data from "../../fixtures/mqg_qa/config_revolvinglineofcredit.json"
...
const prdName6 = Cypress.env('prdName6')
...
before(() => {
    ...
    cy.wait(1000)
    ProductWizardPage.selectProduct(prdName6, relationshipName, testEnv)
...
describe('Verify Field configurations in Product Attributes Section', () => {
    ...
    let dropDownFields = ['productcurrencyCode', 'productcreditRatingCode', 'producttreatmentType', 'productloanPurpose', 'productsecurityType', 'productlvr',
                            'productlGDOverride']

import * as data from "../../fixtures/fitb_qa/config_constructiontoperm.json"
...
const prdName = "Construction to Permanent"
...
const validationDeal = "validateConstructionToPerm" + dateNow
...
describe('Verify that the Pricing Page Wizard Page should have the correct heading labels', () => {
    let headers = ['General', 'Construction Phase Attributes', 'Permanent Phase Attributes', 'Fees & Costs'] // headings that will be tested
...
describe('Verify Field configurations in Construction Phase Attributes Section', () => {

    // Fields that will be tested
    let inputTextFields = data.fieldsData["ConstPhaseInputFields"]
    let dropDownFields = data.fieldsData["ConstPhaseDropDownFields"]
...
describe('Verify Field configurations in Permanent Phase Attributes Section', () => {

    // Fields that will be tested
    let inputTextFields = data.fieldsData["PermPhaseInputFields"]
    let dropDownFields = data.fieldsData["PermPhaseDropDownFields"]

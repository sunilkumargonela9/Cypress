import * as data from "../../fixtures/fitb_qa/config_certificatesofdeposit.json"
...
const prdClass = "Deposit"
const prdCategory = "Certificates of Deposit"
const prdName = "Certificates of Deposit"
...
const validationDeal = "validateCertificatesofDeposit" + dateNow
...
describe('Verify that the Pricing Page Wizard Page should have the correct heading labels', () => {
    let headers = ['General', 'Deposit Attributes'] // headings that will be tested
...
describe('Verify Field configurations in Deposit Attributes Section', () => {

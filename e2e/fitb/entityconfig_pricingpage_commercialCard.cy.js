import * as data from "../../fixtures/fitb_qa/config_commerciallending.json"
...
const validationDeal = "valideCommercialCard" + dateNow
...
//     it('Verify Fees Table Configuration configuration for Unused Commitment Fee', () => {
//         ProductPage.validateFeeName("Unused Commitment Fee", data)
//         ProductPage.validatePaymentFreq("Unused Commitment Fee", data, "enabled")
//         ProductPage.validateTableDdlFieldOptions("Unused Commitment Fee", data)
//         ProductPage.validateProposedFee("Unused Commitment Fee", data, "enabled")
//         ProductPage.validateFeeIfWaived("Unused Commitment Fee", data, "enabled")
//     })

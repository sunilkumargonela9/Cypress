import * as data from "../../fixtures/fitb_qa/config_interestratederivatives.json"
...
const prdCategory = "Financial Risk Management"
const prdName = "Interest Rate Derivatives"
...
const validationDeal = "validateInterestRateDerivatives" + dateNow
...
describe('Verify that the Pricing Page Wizard Page should have the Fees and Cost table configuratrion', () => {
    ...
    it('Verify Fees Table Configuration configuration for Derivative Fee', () => {
        ProductPage.validateFeeName("Derivative Fee", data)
        ProductPage.validatePaymentFreq("Derivative Fee", data, "disabled")
        ProductPage.validateProposedFee("Derivative Fee", data, "enabled")
        ProductPage.validateFeeIfWaived("Derivative Fee", data, "enabled")
    })

...
const dealName = "DealCheck_TermDeposit" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_termdeposit.json"
const payload_path = "cypress/fixtures/global_qa/payload_termdeposit.json"
const response_file_path = "cypress/fixtures/actual_termdeposit.json"

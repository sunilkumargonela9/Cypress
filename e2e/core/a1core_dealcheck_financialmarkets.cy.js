...
const dealName = "DealCheck_FinancialMarkets" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_financialmarkets.json"
const payload_path = "cypress/fixtures/global_qa/payload_financialmarkets.json"
const response_file_path = "cypress/fixtures/actual_financialmarkets.json"

...
const dealName = "DealCheck_WealthManagement" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_wealthmanagement.json"
const payload_path = "cypress/fixtures/global_qa/payload_wealthmanagement.json"
const response_file_path = "cypress/fixtures/actual_wealthmanagement.json"

...
const dealName = "DealCheck_TradeSolutions" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_tradesolutions.json"
const payload_path = "cypress/fixtures/global_qa/payload_tradesolutions.json"
const response_file_path = "cypress/fixtures/actual_tradesolutions.json"

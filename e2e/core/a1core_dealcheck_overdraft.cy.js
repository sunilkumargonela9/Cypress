...
const dealName = "DealCheck_Overdraft" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_overdraft.json"
const payload_path = "cypress/fixtures/global_qa/payload_overdraft.json"
const response_file_path = "cypress/fixtures/actual_overdraft.json"

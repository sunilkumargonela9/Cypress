...
const dealName = "DealCheck_AssetFinance" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_assetFinance.json"
const payload_path = "cypress/fixtures/global_qa/payload_assetFinance.json"
const response_file_path = "cypress/fixtures/actual_assetFinance.json"

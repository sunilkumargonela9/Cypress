...
const dealName = "DealCheck_AssetManagement" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_assetManagement.json"
const payload_path = "cypress/fixtures/global_qa/payload_assetManagement.json"
const response_file_path = "cypress/fixtures/actual_assetManagement.json"

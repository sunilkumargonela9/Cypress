...
const dealName = "DealCheck_TransactionalBanking" + dateNow
const dealCode = dateNow


const control_file_path = "cypress/fixtures/global_qa/controlfile_transactionalbanking.json"
const payload_path = "cypress/fixtures/global_qa/payload_transactionalbanking.json"
const response_file_path = "cypress/fixtures/actual_transactionalbanking.json"
